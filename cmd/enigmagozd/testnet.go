...
Example:
	enigmagozd testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "enigmagozd",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "enigmagozcli",
...
func InitTestnet(
	...
	for i := 0; i < numValidators; i++ {
		...
		gaiaConfigFilePath := filepath.Join(nodeDir, "config/enigmagozd.toml")
