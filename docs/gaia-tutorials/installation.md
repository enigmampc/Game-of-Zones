...
This guide will explain how to install the `enigmagozd` and `enigmagozcli` entrypoints
...
correct [released version](https://github.com/enigmampc/Game-of-Zones/releases).
...
That will install the `enigmagozd` and `enigmagozcli` binaries. Verify that everything is OK:
...
`enigmagozcli` for instance should output something similar to:
