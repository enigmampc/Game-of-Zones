...
BINDIR ?= $(GOPATH)/bin
SIMAPP = github.com/enigmampc/Game-of-Zones/app
...
test-sim-custom-genesis-fast:
	...
	@echo "By default, ${HOME}/.enigmagozd/config/genesis.json will be used."
	@go test -mod=readonly $(SIMAPP) -run TestFullGaiaSimulation -Genesis=${HOME}/.enigmagozd/config/genesis.json \
...
test-sim-custom-genesis-multi-seed: runsim
	...
	@echo "By default, ${HOME}/.enigmagozd/config/genesis.json will be used."
	@$(BINDIR)/runsim -Jobs=4 -Genesis=${HOME}/.enigmagozd/config/genesis.json 400 5 TestFullGaiaSimulation
